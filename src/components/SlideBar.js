    ...
    <div className="flex-none hidden lg:block  bg-black h-screen min-w-[25%] fixed ">
        ...
        <div data-aos="slide-down">
          <NavLink to={"/activity"}>
            <img
              ...
              alt="purimrach charoensiriraditon"
      ...
      >
        ...
        <div
          title="Instagram"
          onClick={() =>
            window.open("https://www.instagram.com/benz5_0_7?igsh=ODA1NTc5OTg5Nw==", "_blank")
          }
        >
          {" "}
        ...
        <div
          title="Facebook"
          onClick={() =>
            window.open("https://www.facebook.com/benz.zaa.52035/", "_blank")
          }
        >
